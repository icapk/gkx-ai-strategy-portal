...
export function ReadingReviewSidebar() {
  ...
  return <>
    <aside className={`reading-review ${reviewMode!=='design'?'is-prd':''} ${collapsed?'is-collapsed':''}`} aria-label="智能阅读评审">
