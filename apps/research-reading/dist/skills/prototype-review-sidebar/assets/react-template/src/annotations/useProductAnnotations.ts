import {prdDisplayNumbers} from '../researchReview/prdDisplay.ts'
import { useRef, useState } from 'react'
import type { PrdBook } from '../researchReview/prdStore.ts'
import { researchLocations, researchTargets } from '../prototypeFocus/researchTargets.ts'
import { readingLocations, readingTargets } from '../prototypeFocus/readingTargets.ts'
import { readManual, readReadingManual, type ManualMapping } from '../prototypeFocus/manual.ts'
import type { PrototypeModule } from '../prototypeFocus/types.ts'
import { useAnnotations } from './useAnnotations.ts'
import type { AnnotationCreateRequest, AnnotationFeature } from './uiTypes.ts'
