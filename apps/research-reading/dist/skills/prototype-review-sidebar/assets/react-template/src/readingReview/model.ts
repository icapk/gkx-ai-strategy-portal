...
export const groups=catalogs.reading.groups
export const points:ReviewPoint[]=catalogs.reading.points
...
export interface Filters { mode:'design'; group:string; parent:string; child:string; stories:number[]; statuses:Status[]; priorities:Priority[] }
