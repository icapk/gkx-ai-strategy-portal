...
import { researchLocations, researchTargets } from './researchTargets.ts'
import { readingLocations, readingTargets } from './readingTargets.ts'
import { clippedTargetFrame, sidebarEdge, type TargetFrame } from './geometry.ts'
import { prepareFocus } from './prepare.ts'
import type { PrototypeFocusRequest, PrototypeModule } from './types.ts'
import './focus.css'
import { readManual, readReadingManual } from './manual.ts'
import type { ManualMapping } from './manual.ts'
import { currentAnnotationContext, savedRangeMatchesContext } from '../annotations/location.ts'
import { restoreAnnotationState } from '../annotations/restoration.ts'
import type { AnnotationRange } from '../annotations/uiTypes.ts'
