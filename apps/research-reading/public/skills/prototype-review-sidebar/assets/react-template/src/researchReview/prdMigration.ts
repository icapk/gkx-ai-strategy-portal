import { prdAreas, legacyPrdAreas, type PrdFeature } from './prd.ts'
import { authoredRules, splitRuleText } from './prdRules.ts'
import type { PrdBook, PrdRevision } from './prdStore.ts'
